...
public sealed class WorkspaceManager : IWorkspaceWindowSource
{
    ...
    public IReadOnlyList<IntPtr> GetCurrentWorkspaceWindows() =>
        windowsByWorkspace[currentWorkspace].ToArray();
